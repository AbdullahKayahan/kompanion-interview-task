...
const ImageItem = ({
  ...
  return (
    ...
    borderRadius: DesignTokens.radiuses.half
        ...
        <View style={{flex:1, flexDirection:"row", alignItems:"center" , backgroundColor:Colors.cardBackground}} >
        <Image
        ...
        <IconButton text={"250"} icon={"heart-o"} color={Colors.tertiaryColor} style={{backgroundColor:Colors.cardBackground}} />
        </View>
    </View>
  );
};

...
const ImageItem = ({
  ...
  return (
    ...
    borderRadius: DesignTokens.radiuses.half
        ...
        <View style={{flex:1, flexDirection:'row', alignItems:"center"}}>
        <IconButton text={"250"} icon={"heart-o"} color={Colors.tertiaryColor} style={{backgroundColor:Colors.cardBackground, margin: DesignTokens.spaces.item}} />
        </View>
        <View style={{flex:2, flexDirection:"row", alignItems:"center", backgroundColor:"red"}}>

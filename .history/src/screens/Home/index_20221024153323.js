...
const HomePage = ({
    ...
    //Anasayfadaki videolara basınca play-puse yapmak için kullanılır
    const onVideoItemPress = (item) => {
        setListData(
            listData.map((_item) => {
                if (_item.id === item.id) {
                    return {
    ...
    //Searh ekranındaki videolara basınca play-puse yapmak için kullanılır
    const onGridVideoItemPress = (item) => {
        setSearchListData(
        ...
        return (
            <View style={Styles.mainView}>
                <FlatList
                    ...
                    renderItem={(item) => renderHomePageItem(item)}
                />
            </View>
        );
    };
